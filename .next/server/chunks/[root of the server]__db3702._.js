...
"[project]/src/lib/meal-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class MealService {
    ...
    static async saveMealPlan(userId, selections) {
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"];
        const db = client.db("mealplanner");
    ...
    static async getMealHistory(userId) {
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"];
        const db = client.db("mealplanner");
        const history = await db.collection("mealHistory").find({
            userId
        }).sort({
            date: -1
        }).limit(10).toArray();
    ...
    static async addToHistory(userId, mealEntry) {
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"];
        const db = client.db("mealplanner");
    ...
    static async saveUserFood(userId, food) {
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"];
        const db = client.db("mealplanner");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$meal$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/meal-service.ts [app-route] (ecmascript)");
;
;
async function GET() {
    const userId = "default-user";
    try {
        const history = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$meal$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MealService"].getMealHistory(userId);
...
async function POST(request) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$meal$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MealService"].addToHistory(userId, mealEntry);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__db3702._.js.map