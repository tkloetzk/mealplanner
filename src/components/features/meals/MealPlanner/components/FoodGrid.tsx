...
import type { Food, FoodContext } from '@/types/food';
...
export const FoodGrid = React.memo(({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-14">
      ...
      {(Object.entries(foodOptions) as [CategoryType, Food[]][]).map(([category, foods]) => {
                  ...
                  {compatibleFoods.map((food, index) => {
                    ...
                    return (
                      <FoodItem
                        ...
                        onServingClick={() => onServingClick(validCategory, food)}
