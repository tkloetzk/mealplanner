...
describe("imageUtils", () => {
  describe("getFoodImageSource", () => {
    ...
    it("returns cloudinary URL when available", () => {
      const food: Food = {
        ...baseFoodProps,
        cloudinaryUrl:
          "https://res.cloudinary.com/example/image/upload/v123/test.jpg",
    ...
    it("prioritizes cloudinary over other options", () => {
      const food: Food = {
        ...baseFoodProps,
        cloudinaryUrl:
          "https://res.cloudinary.com/example/image/upload/v123/priority.jpg",
  ...
  describe("isValidUrl", () => {
    it("returns true for valid HTTP URLs", () => {
      ...
      expect(isValidUrl("https://subdomain.example.com/path/to/resource")).toBe(
        true
      );
    });
