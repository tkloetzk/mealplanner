...
describe("AnalysisButtons", () => {
  ...
  it("renders buttons with expected content", () => {
    ...
    const imageButton = screen.getByRole("button", {
      name: /analyze plate photo/i,
    });
    const mealButton = screen.getByRole("button", {
      name: /analyze meal plan/i,
    });
  ...
  it("disables meal analysis when no meal is selected", () => {
    render(<AnalysisButtons {...defaultProps} selectedMeal={null} />);
  ...
  it("disables meal analysis when no meal selection exists", () => {
    render(<AnalysisButtons {...defaultProps} currentMealSelection={null} />);
