...
"[project]/src/lib/foods-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class FoodsService {
    ...
    static async getFoodsByCategory(category) {
        try {
            const client = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"];
            const db = client.db("mealplanner");
            return await db.collection("foods").find({
                category
            }).toArray();
        } catch (error) {
...
"[project]/src/app/api/foods/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$foods$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/foods-service.ts [app-route] (ecmascript)");
;
;
async function GET() {
    try {
        const foods = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$foods$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FoodsService"].getAllFoods();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(groupedFoods);
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a12eb4._.js.map